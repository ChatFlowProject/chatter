import { FieldInfos, FieldValue } from '../../../../lib/types/auth/LoginTypes';
import {
  isEmail,
  isEmptyString,
  isLengthBetween,
  ...
  isNickname,
  isPassword,
} from '@utils/auth/stringValidations';
import { useState } from 'react';
import { signUp } from 'src/feature/auth/api/authService';
import useForm from 'src/feature/auth/useForm';
