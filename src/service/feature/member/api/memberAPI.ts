...
import {
  MemberInfo, SearchMemberResult, SearchMembersRequest,
...
export const updateMemberStatus = async (data: UpdateMemberStatusRequest): Promise<void> => {
  await axios.patch('/members/status', data);
};

export const updateMemberInfo = async (data: UpdateMemberInfoRequest): Promise<void> => {
  await axios.put('/members', data);
};

export const searchMembers = async (data: SearchMembersRequest): Promise<SearchMemberResult[]> => {
