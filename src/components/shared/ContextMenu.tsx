...
function Item({
  ...
  return (
    <div
      className={`hover:bg-primary ${isWarning && 'hover:bg-red'} rounded-[3px] bg-[#202225] flex w-[117px] justify-between items-center px-2 py-1`}
    >
...
export default function ContextMenu() {
  return (
    <div className='bg-[#202225] inline-flex flex-col p-1'>
      <Item name='프로필' />
      <Item name='멘션' />
      <Item name='메시지' />
      <Item name='통화' />
